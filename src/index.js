...
function create() {
  moneyText = this.add.text(500, 16, `$${money.getMoney()}`, {
    fontSize: '32px',
    fill: '#fff'
  });
  ...
  let enemyHp = 200
  //線、速度(越大越快)、血量
  let myEnemy = new Phaser.Class(Enemy(path, enemySpeed, enemyHp, money))
  ...
  this.input.on('pointerdown', pointer => {
    myMap.placeTurret(pointer, turrets, money, 30)
